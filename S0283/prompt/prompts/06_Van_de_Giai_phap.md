...
## Công việc
Dựng section giai-phap: ảnh trái 45%, nội dung phải 55%; ba vấn đề rõ ràng và đoạn giải thích dịch vụ. Nền be cát. Mobile một cột, thứ tự đọc có nghĩa. Liên kết giải pháp với đầu ra; hạn chế thuật ngữ chưa giải thích. Không thêm carousel.

## Tiêu chí hoàn thành
Nội dung khớp nguồn; ảnh không méo; không lặp nguyên đoạn hero.
