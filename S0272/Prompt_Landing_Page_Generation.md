# Prompt Kỹ thuật: Tạo Landing Page Dịch vụ S0272 (Carbon footprint)

**Vai trò của bạn:** Bạn là một Frontend Engineer xuất sắc, am hiểu thiết kế UI/UX hiện đại.

**Nhiệm vụ:**
Phát triển một trang Landing Page (HTML/CSS/JS) cho dịch vụ "Dịch vụ lập bản đồ Carbon footprint" (S0272) của công ty GASCOLAE.
